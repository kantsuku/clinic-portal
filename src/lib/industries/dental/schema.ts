...
export const sections: SectionDef[] = [
  ...
  },
  {
    id: "chairman",
    title: "理事長プロフィール",
    description: "医療法人の場合、理事長の情報を教えてください！（該当しない場合はスキップOK）",
    icon: "Crown",
    ...
    fields: [
      {
        ...
        label: "理事長のお名前",
        type: "text",
        placeholder: "例：山田 一郎（やまだ いちろう）",
        hint: "医療法人でない場合は空欄のままでOKです！",
        dnaSheet: "10_Staff_Master",
        dnaField: "name",
      },
      {
        name: "chairman_career",
        label: "理事長のご経歴",
        type: "textarea",
        placeholder: "例：\n〇〇大学卒業\n〇〇医院勤務\n19XX年 医療法人〇〇会 設立",
        dnaSheet: "10_Staff_Master",
      ...
      {
        name: "chairman_greeting",
        label: "理事長のご挨拶文",
        type: "textarea",
        placeholder: "HPに載せる理事長メッセージ（ラフでOK）",
        hint: "院長挨拶とは別に理事長挨拶を載せる場合にどうぞ！",
        dnaSheet: "10_Staff_Master",
        dnaField: "notes",
      },
    ],
        ...
        checklistCategories: [
          {
            ...
            items: [
              ...
              "AED", "生体情報モニター", "外来環（歯科外来診療環境体制）", "か強診（かかりつけ歯科医強化型診療所）",
            ],
          },
          {
            name: "虫歯治療",
            items: [
              ...
              "レーザー治療", "3Mix法", "カリソルブ", "マイクロスコープ", "う蝕検知液",
            ],
          },
          {
            name: "歯周病治療",
          ...
          },
          {
            ...
            items: [
              // 資格・認定
              "矯正認定医", "矯正専門医", "Invisalign認定ドクター",
              // 診断・デジタル設備
              "セファロ", "CT", "iTero", "歯科用CT", "3Dプリンター", "suresmile", "Dolphin imaging",
              // マウスピース矯正
              "マウスピース矯正（インビザライン）", "マウスピース矯正", "インビザライン", "インビザライン・ティーン", "クリアコレクト", "インハウスアライナー",
              // 表側矯正（ラビアル）
              "表側矯正", "オパール・エイベックス", "IDBシステム", "セルフライゲーションシステム", "デーモンクリア（デーモンシステム）", "デーモンシステム",
              "エイベックスCX セラミックブラケット", "クリアティ アドバンス", "クリアティ SL",
              "ジルコニア・ブラケット", "強化プラスチック製ブラケット", "ホワイトワイヤー", "アンカーインプラント",
              // 舌側矯正（リンガル）
              "舌側矯正（裏側矯正）", "ハーフリンガル", "フルリンガル", "ALIASブラケット", "STb舌側矯正",
              "ストレートリンガルワイヤー法", "ストレートワイヤー（L.S.W）法", "セルフライゲーティングブラケット",
              // 治療範囲
              "部分矯正", "裏側矯正", "ワイヤー矯正", "片顎治療", "後戻り矯正",
              // 補助テクニック
              "ディスキング", "サージェリーファースト", "光加速矯正装置（PBMヒーリングオルソ）",
              // 患者サービス
              "紛失対応", "無料シミュレーション", "無料相談",
            ],
          },
          {
            name: "インプラント",
          ...
          },
          {
            name: "審美歯科",
            items: [
              "デジタルスキャナー", "セレック（CEREC）",
              "ダイレクトボンディング", "グラディアダイレクト", "ラミネートベニア", "ガミースマイル",
          ...
          },
          {
            ...
            items: [
              ...
              "日本歯科保存学会認定医", "歯内療法専門医",
              "歯根端切除術", "ファイバーコア", "MTAセメント", "バイオセラミックシーラー",
              "セカンドオピニオン",
            ],
          },
          {
          ...
          },
          {
            name: "睡眠時無呼吸・いびき治療",
            items: [
              "睡眠時無呼吸症候群（SAS）対応", "いびき治療",
              "オーラルアプライアンス（マウスピース）", "スリープスプリント",
              "簡易PSG検査（パルスオキシメトリー）", "医科との連携（紹介状対応）",
              "CPAP併用管理", "顎位調整",
            ],
          },
        ],
